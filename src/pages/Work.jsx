...
export default function Work(){
  return(
    <div className="max-w-7/8 space-y-6k">
      ...
      <section className="md:ml-30 mt-30 mr-40 space-y-5">
        <h1 className="text-5xl text-brand font-bold mb-8">Work examples</h1>
        <CaseStudy 
        ...
        >
          ...
          <Diagram className="bg-yellow-400 mt-10 mb-10" title="Chart widget refactoring">
            <img className="w-150 py-10 h-auto m-auto" src={csDiagram1_1} />
          </Diagram>
          ...
          <Diagram className="bg-yellow-400 w-1/2" title="Functional render & method overrides">
            <img className="w-70 py-10 h-auto m-auto" src={csDiagram1_2} />
          </Diagram>
        </CaseStudy>
        <CaseStudy 
        ...
        <Diagram className="bg-yellow-400 w-1/2" title="Fivetran sync flow">
          <img className="w-130 py-10 h-auto m-auto" src={csDiagram2_1} />
        </Diagram>
        </CaseStudy>
        <CaseStudy 
        ...
        <Diagram className="bg-yellow-400 w-5/8 pb-0" title="Style Guide Reference">
          <a href={styleGuide} target="_blank"><img className="w-330 pt-10 pl-10 pr-10 h-auto m-auto" src={csDiagram3_1} /></a>        </Diagram>
        </CaseStudy>
        <CaseStudy 
        ...
        <Diagram className="bg-yellow-400 w-3/4" title="Main workflow page performance improvement">
          <img className="w-330 pt-10 pl-10 pr-10 h-auto m-auto" src={csDiagram4_1} />
        </Diagram>
        </CaseStudy>
      </section>
    </div>
